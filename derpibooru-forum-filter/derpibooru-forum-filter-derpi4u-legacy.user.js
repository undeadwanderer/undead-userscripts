...
// @include      *
// @require      https://raw.githubusercontent.com/MarkTaiwan/Derpibooru-Unified-Userscript-Ui/master/derpi-four-u.js?1.2.3
// @inject-into  content
// @grant        none
...
function mainFunction() {
    ...
    config.registerSetting({
        title: 'Filter words',
        key: 'marker0',
        description: 'The words or phrases you wish to filter. Case-insensitive. Separate filters with commas.',
        type: 'text',
    ...
    config.registerSetting({
        title: 'Escape words',
        key: 'escape0',
        description: 'The words or phrases you wish to exclude from the filter. Case-insensitive. Separate filters with commas.',
        type: 'text',
