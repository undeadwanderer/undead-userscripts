...
### Scripts currently in beta:
- `derpibooru-tag-highlighter` — A new experiment that adds a plate with tags of your choice to the images having them. An early beta, can't seem to integrate the new plate well so far. Configuration only through my fork of Derpy4U for now.
